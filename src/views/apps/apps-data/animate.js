	...
	presetAnimations: [
		{
			...
			keyframes: {"0.0%":{"timelinePosition":{"left":"0.0%"},"transformProps":{"scale":"1","translate":"0, 0","skew":"0deg"},"properties":{"transform":"scale(1) translate(0, 0) skew(0deg)"}},"5.1%":{"timelinePosition":{"left":"5.1%"},"transformProps":{"scale":"1","translate":"0, 0","skew":"-12deg"},"properties":{"transform":"scale(1) translate(0, 0) skew(-12deg)"}},"39.9%":{"timelinePosition":{"left":"39.9%"},"transformProps":{"scale":"1","translate":"180px, 0","skew":"-5deg"},"properties":{"transform":"scale(1) translate(180px, 0) skew(-5deg)"}},"95.1%":{"timelinePosition":{"left":"95.1%"},"transformProps":{"scale":"1","translate":"0, 0","skew":"12deg"},"properties":{"transform":"scale(1) translate(0, 0) skew(12deg)"}},"99.6%":{"timelinePosition":{"left":"99.6%"},"transformProps":{"scale":"1","translate":"0, 0","skew":"0deg"},"properties":{"transform":"scale(1) translate(0, 0) skew(0deg)"}},"45.3%":{"timelinePosition":{"left":"45.3%"},"transformProps":{"scale":"1","translate":"180px, -6px","skew":"0deg"},"properties":{"transform":"scale(1) translate(180px, -6px) skew(0deg)"}},"50.3%":{"timelinePosition":{"left":"50.3%"},"transformProps":{"scale":"1","translate":"180px, 0px","skew":"0deg"},"properties":{"transform":"scale(1) translate(180px, 0px) skew(0deg)"}},"55.3%":{"timelinePosition":{"left":"55.3%"},"transformProps":{"scale":"1","translate":"180px, -10px","skew":"0deg"},"properties":{"transform":"scale(1) translate(180px, -10px) skew(0deg)"}},"60.3%":{"timelinePosition":{"left":"60.3%"},"transformProps":{"scale":"1","translate":"180px, 0px","skew":"5deg"},"properties":{"transform":"scale(1) translate(180px, 0px) skew(5deg)"}}}
		},
		{
			name: "Heart",
